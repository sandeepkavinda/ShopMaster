 ...
 * @author Sandeep
 */
public class GRNPaymentD extends javax.swing.JDialog {

    private String grnBarcode;
    private GrnTotalsDTO grnTotalsDTO;
    private HashMap<Integer, Integer> paymentMethodIdMap = new HashMap<>();

    public GRNPaymentD(java.awt.Frame parent, boolean modal, String grnBarcode) {
        super(parent, modal);
    ...
    private void pay() {
        ...
        if (!Validation.isValidBigDecimal(payingAmountText)) {
            ...
            if (payingAmount.compareTo(BigDecimal.ZERO) <= 0) {
    ...
    private void initComponents() {
        ...
        clearSearchButton.setText("Pay Later");
        ...
        referenceNoTextField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                referenceNoTextFieldKeyReleased(evt);
            }
        });
    ...
    private void referenceNoTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_referenceNoTextFieldKeyReleased
    }//GEN-LAST:event_referenceNoTextFieldKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GRNPaymentD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
