...
public final class DateChooser extends javax.swing.JPanel {
    ...
    public void showPopup(Component com, int x, int y) {
        dateChooser.show(com, x, y);
    }

    public void showPopup() {
        dateChooser.show(textRefernce, 0, textRefernce.getHeight());
    }
    ...
    private void initComponents() {
        ...
        dateChooser = new javax.swing.JPopupMenu(){
            @Override
    ...
    private javax.swing.JPopupMenu dateChooser;
